...
thespecies1name = thespecies1.name;%glycanStruct.toString;
isomername1=regexprep(thespecies1name,'--\w*+-','');

% compare the name
if(isprop(thespecies2,'name'))
    thespecies2name = thespecies2.name;%glycanStruct.toString;
else
    error('end');
end

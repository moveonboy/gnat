...
s6species    = GlycanSpecies(glycanMLread('s6v1_1865.glycoct_xml')) ;
...
s14species    = GlycanSpecies(glycanMLread('s14v1_2431.glycoct_xml')) ;
...
s17species    = GlycanSpecies(glycanMLread('s17v1_2605.glycoct_xml')) ;

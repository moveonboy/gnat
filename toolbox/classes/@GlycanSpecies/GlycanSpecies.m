...
% Rev: add the support to transport events
    ...
    methods
        function new = clone(obj,varargin)
           ...
           if(isstructclone)
              new.glycanStruct   = obj.glycanStruct.clone;
           else
              new.glycanStruct   = obj.glycanStruct; 
           end           
           
           new.glycanTypeSpec = obj.glycanTypeSpec;
           new.mark = new.mark;
           new.markState = new.markState ;
           new.initConc = new.initConc;
           new.initAmount =  new.initAmount;
           new.compartment = [];
           new.units = new.units;
           new.name = new.name;
           new.id =  new.id;
           new.timeConc = new.timeConc;
        end
    end
end

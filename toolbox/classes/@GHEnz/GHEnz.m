classdef GHEnz < HLEnz
    ...
    methods
        function resVec = dispFuncResLink(obj)
            ...
            %
            %  See also GHlENZ
            if(~isempty(obj.resfuncgroup)&&~isempty(obj.linkFG)) 
        ...
        function res = dispAttachResLink(obj)
            ...
            %
            %  See also GHlENZ
            if( ~isempty(obj.resAtt2FG) &&...
                ~isempty(obj.linkresAtt2FG))
                res = obj.resAtt2FG.name;
                res = [res,'{'];
                res = [res,obj.linkresAtt2FG.anomer];
                res = [res,'}'];
                res = [res,obj.linkresAtt2FG.bond.disp];
           else
                res='';
           end
        end

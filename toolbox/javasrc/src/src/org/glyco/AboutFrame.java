...
public class AboutFrame extends JDialog
{
	...
	public AboutFrame(Frame owner)
	{
		...
		// Adds title
		JLabel titleLabel = new JLabel("About GNV");
		...
		JLabel subtitleLabel = new JLabel(
				"For more information visit http://www.eng.buffalo.edu/~neel");
		...
		content.add(new JLabel("Glycosylation Network Visualizer - Using The Swing Portion of mxGraph"));
